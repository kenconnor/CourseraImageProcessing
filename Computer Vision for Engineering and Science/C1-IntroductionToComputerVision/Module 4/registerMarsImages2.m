function [MOVINGREG] = registerMarsImages2(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 25-Feb-2023
%-----------------------------------------------------------
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',784.375000,'NumOctaves',2,'NumScaleLevels',4);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',784.375000,'NumOctaves',2,'NumScaleLevels',4);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',14.375000,'MaxRatio',0.143750);
